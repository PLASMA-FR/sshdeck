...
pub fn draw(f:&mut Frame, app:&mut App, area:Rect){
    ...
    let y=chunks[0].y+chunks[0].height.saturating_sub(3);
    app.mouse.register(Rect{x:chunks[0].x+2,y,width:12,height:1},start.clone());
    app.mouse.register(Rect{x:chunks[0].x+16,y,width:12,height:1},cancel.clone());
